...
class SLMbaseController(ImConWidgetController):
    """Linked to SLMbaseWidget."""

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
        self.__logger = initLogger(self)

        if self._setupInfo.slm.managerName != "SLMbaseManager":
            self._widget.replaceWithError('SLMbaseManager is not configured in your setup file.')
            return
